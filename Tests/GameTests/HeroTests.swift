...
@Suite struct RuneTreeTests {
    ...
    @Test func partySlotsUnlockInOrder() {
        func expectUnlock(
            _ tree: inout RuneTree,
            _ node: RuneTreeNode,
            heroLevel: Int = 3,
            availableGold: Int = 0,
            expected: Bool = true
        ) {
            let didUnlock = tree.unlock(node, heroLevel: heroLevel, availableGold: availableGold)
            #expect(didUnlock == expected)
        }
        ...
        expectUnlock(&tree, .allHeroAttackDamage1)
        ...
        expectUnlock(&tree, .allHeroArmor1)
        ...
        expectUnlock(&tree, .allHeroMoveSpeed1)
        ...
        expectUnlock(&tree, .allHeroArmor3)
        ...
        expectUnlock(&tree, .allHeroArmorPercent1)
        ...
        expectUnlock(&tree, .allHeroAttackDamagePercent2)
        ...
        expectUnlock(&tree, .allHeroAttackSpeed1)
        ...
        expectUnlock(&tree, .allHeroAttackSpeed2)
        ...
        expectUnlock(&tree, .allHeroArmor2)
        ...
        expectUnlock(&tree, .allHeroAttackDamage2)
        ...
        expectUnlock(&tree, .allHeroArmorPercent2)
        ...
        expectUnlock(&tree, .allHeroAttackDamagePercent3)
        ...
        expectUnlock(&tree, .allHeroAttackSpeed3)
        ...
        expectUnlock(&tree, .cubeXPBoost1)
        ...
        expectUnlock(&tree, .alchemyGoldBoost1)
        #expect(tree.alchemyGoldMultiplier == 1.0 + RuneTree.cubeRewardMultiplierBonus)
        expectUnlock(&tree, .cubeXPBoost2, expected: false)
        expectUnlock(&tree, .alchemyGoldBoost2)
        #expect(tree.alchemyGoldMultiplier == 1.0 + RuneTree.cubeRewardMultiplierBonus * 2.0)
        expectUnlock(&tree, .alchemyGoldBoost4, expected: false)
        expectUnlock(&tree, .cubeXPBoost2)
        expectUnlock(&tree, .cubeXPBoost3)
        expectUnlock(&tree, .cubeXPBoost4)
        #expect(tree.cubeExperienceMultiplier == 1.0 + RuneTree.cubeRewardMultiplierBonus * 4.0)
        expectUnlock(&tree, .alchemyGoldBoost3)
        expectUnlock(&tree, .alchemyGoldBoost4)
        ...
        expectUnlock(&combatRewardTree, .combatGoldBoost1)
        #expect(combatRewardTree.combatGoldMultiplier == 1.0 + RuneTree.combatRewardMultiplierBonus)
        expectUnlock(&combatRewardTree, .combatXPBoost1)
        ...
        expectUnlock(&offlineBoostTree, .offlineXPBoost2, expected: false)
        expectUnlock(&offlineBoostTree, .offlineGoldBoost2)
        expectUnlock(&offlineBoostTree, .offlineGoldBoost3)
        expectUnlock(&offlineBoostTree, .offlineGoldBoost4)
        expectUnlock(&offlineBoostTree, .offlineGoldBoost5)
        expectUnlock(&offlineBoostTree, .offlineXPBoost2)
        expectUnlock(&offlineBoostTree, .offlineXPBoost3)
        expectUnlock(&offlineBoostTree, .offlineXPBoost4)
        expectUnlock(&offlineBoostTree, .offlineXPBoost5)
